...
**Інструменти / MCP.** Claude Code (Opus) з кастомними скілами та суб-агентами; CodeRabbit як зовнішнє AI-рев'ю. `<ДОДАЙ, якщо використовував: GitHub / Figma MCP тощо — або прибери цей рядок>`
